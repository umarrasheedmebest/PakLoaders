...
const ExpandableCoponent = () => {
  ...
  return (
    <View
      ...
      <Text
        style={{fontSize: 16, fontFamily: 'Poppins-Regular', color: '#4448FF'}}>
        Plan overview
      </Text>
      <Text
        style={{fontSize: 12, fontFamily: 'Poppins-Regular', color: '#A5A5A5'}}>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.mainContainer, styles.commonStyle]}>
        ...
        <View style={{width: '100%', marginTop: 20}}>
          <Text style={styles.headingStyle}>{mark?eng.insurnacePack:Urdu.insurnacePack}</Text>
        </View>
        {/* Heading */}
        <View style={{alignItems: 'flex-start', marginTop: 5}}>
          <Text style={styles.paragraphStyle}>
            {mark?eng.purchasePlan:Urdu.purchasePlan}
          </Text>
        </View>
        <View>
          <View
            style={{
              ...
              marginTop: 10,
              borderRadius: 7,
              backgroundColor: enableList ? '#D9DAFF' : '#EDEDED',
            }}>
          ...
          <View
            style={{
              ...
              marginTop: 10,
              borderRadius: 7,
              backgroundColor: secondList ? '#D9DAFF' : '#EDEDED',
            }}>
          ...
          <View
            style={{
              ...
              marginTop: 10,
              borderRadius: 7,
              backgroundColor: thirdList ? '#D9DAFF' : '#EDEDED',
            }}>
