...
const Sure = ({
  ...
  return addCard ? (
      ...
      <View style={[styles.loader, {height: 460}]}>
        <View>
          <View style={{width: '100%', alignItems: 'center', marginTop: 30}}>
            <Text style={{fontSize: 20, fontWeight: 'bold', color: '#4448FF'}}>
              Add a Card
            </Text>
          </View>
    ...
    <View style={[styles.container, {height, width}]}>
      <View style={styles.profile}>
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Image
              style={{width: 17.12, height: 16.28}}
          ...
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Image
                ...
                source={require('../../assets/reviewProfile.png')}
              />
              <View style={{marginLeft: 10}}>
                <Text
                  style={{fontSize: 11, fontWeight: '500', color: colors.text}}>
                  Jhone
                </Text>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <Image source={require('../../assets/Stars.png')} />
                  <Text
                    style={{fontSize: 7, color: colors.text, marginLeft: 7}}>
                    (4.1)
                  </Text>
                </View>
              </View>
            ...
            <View>
              <Text style={{fontSize: 10, color: '#9D9D9D'}}>3s ago</Text>
            </View>
          </View>
          <View>
            <Text
        ...
        <View style={[styles.profileContainer, {marginTop: 15}]}>
          <View
            ...
            <View>
              <Text style={{fontSize: 10, color: '#9D9D9D'}}>02:06 AM</Text>
            </View>
          </View>
          <View>
            <Text
    ...
    data.map(res => {
      ...
      return (
        <View key={res.id} style={[styles.container, {height, width}]}>
          <View style={styles.loader}>
            <View>
              <View style={styles.image_container}>
                <Image
                  style={styles.image_style}
                  source={require('../../assets/img_!_17.png')}
                />
                <Image
                  style={styles.image_style}
                  source={require('../../assets/img_2_17.png')}
                />
              </View>
              <View
                style={[
              ...
              <View style={{marginVertical: 10}}>
                <View style={[styles.defaultStyle, {marginBottom: 8}]}>
                  <Text style={[{fontSize: 17, fontWeight: '600'}]}>
                    Name:{' '}
                  </Text>
                  <Text style={[styles.text, {fontSize: 17}]}>Usama Ali</Text>
                </View>
                <View style={[styles.defaultStyle, {marginBottom: 8}]}>
                  <Text style={[{fontSize: 17, fontWeight: '600'}]}>
                    Mobile Number:{' '}
              ...
              <View
                style={[
                  styles.defaultStyle,
                  {justifyContent: 'center', width: '100%', zIndex: 11},
                ]}>
                <TouchableOpacity
        ...
        <View>
          ...
          <View style={{width: '100%', alignItems: 'center', marginBottom: 25}}>
            <Text
              ...
              Do you want to get your luggage insured?
            </Text>
          </View>
          <View
            style={[
        ...
        <View>
          ...
          <View style={{width: '100%', alignItems: 'center', marginBottom: 25}}>
            <Text
              ...
              Are you sure you want to ignore this trip?
            </Text>
          </View>
          <View
            style={[
